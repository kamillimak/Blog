      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-zinc max-w-none space-y-8 py-8 text-brand-muted">
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed">
              Jeśli zapiszesz się do newslettera, przetwarzany jest adres e-mail potrzebny do obsługi subskrypcji. Możesz poprosić o usunięcie adresu, pisząc na kontakt@kamillimak.pl.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              <a href="mailto:kontakt@kamillimak.pl" className="font-bold text-brand-text underline underline-offset-4">
